    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-4">
                    <div class="d-grid gap-2 mb-3">
                        ...
                        <button class="btn btn-info" type="submit" name="reset_password"><i class="fa-solid fa-lock-open"></i> Reset Pass</button>
                        <?php if ($user->active == 0) : ?>
                            <button class="btn btn-info" type="submit" name="active"><i class="fi fi-rr-power"></i> Active User</button>
                        <?php else : ?>
                            <button class="btn btn-secondary" type="submit" name="inactive"><i class="fi fi-rr-power"></i> Inactive User</button>
                        <?php endif; ?>
                        <button class="btn btn-danger" type="submit" name="delete" onclick="return confirm('Are you sure you want to delete this user?');"><i
                                class="fi fi-rr-trash"></i> Delete User</button>


                        <a href="#" class="btn btn-warning" data-bs-toggle="modal"
                            data-bs-target="#addgroupModal">Add Role</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <ul class="list-group">
                        <li class="list-group-item fw-bold">Role User</li>
                        <?php foreach ($getroles as $key => $role) : ?>
                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                <div class="ms-2 me-auto">
                                    <?= $role['name']; ?>
                                </div>
                                <a href="<?= base_url('users/removefromgroup/') . $user->id . '/' . $role['group_id'] ?>">
